...
export const ACHIEVEMENT_DEFS: AchievementDef[] = [
  { id: 'volltreffer', title: 'Volltreffer', description: 'Ein „Alle Neune”-Wurf', bonusPoints: 0.5 },
  {
    id: 'serientaeter',
    title: 'Serientäter',
  ...
  { id: 'stammgast', title: 'Stammgast', description: 'Fünf gespielte Partien an einem Tag', bonusPoints: 1 },
  {
    id: 'tiefstapler',
    title: 'Tiefstapler',
