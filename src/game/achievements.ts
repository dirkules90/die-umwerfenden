...
export const ACHIEVEMENT_DEFS: AchievementDef[] = [
  ...
  { id: 'bahnrand-kenner', title: 'Bahnrand-Kenner', description: 'Fünf Rinnenwürfe in einer einzigen Partie' },
  ...
  { id: 'hebel-profi', title: 'Hebel-Profi', description: '100-mal den Hebel erfolgreich betätigt' },
]
